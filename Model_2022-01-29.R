...
# 
# library(changepoint)
# value.ts = ts(cpd$Excess_Death_Rate, frequency=12, start=c(1999,1), end=c(2019,12)) #create subset by date and make it a time series
